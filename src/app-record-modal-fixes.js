...
window.addEventListener('load',()=>{
  for(const src of ['app-branding.js','app-team-scope-clarity.js','app-ui-polish.js','app-status-rag-sync.js','app-workspace-memory.js','app-workspace-startup.js','app-status-report-ui.js','app-attention-health.js','app-assistant-link.js','app-command-menu.js','app-roadmap-groups.js','app-readme-embedded.js','app-readme-assistant.js','app-config-settings.js','app-config-organization-effective.js','app-semantic-filters.js','app-semantic-filter-polish.js']){

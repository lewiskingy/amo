...
window.addEventListener('load',()=>{
  const COMPAT_ASSET_VERSION='20260828-report-links-1';
  for(const src of ['app-branding.js','app-team-scope-clarity.js','app-ui-polish.js','app-status-rag-sync.js','app-workspace-memory.js','app-role-model.js','app-workspace-startup.js','app-status-report-ui.js','app-status-report-collaboration.js','app-status-report-history-compat.js','app-attention-health.js','app-assistant-link.js','app-command-menu.js','app-roadmap-groups.js','app-readme-embedded.js','app-readme-assistant.js','app-config-settings.js','app-role-config.js','app-config-organization-effective.js','app-semantic-filters.js','app-semantic-filter-polish.js','app-financial-planning.js','app-report-renderer.js','app-status-report-presentation.js','app-status-report-deep-links.js']){

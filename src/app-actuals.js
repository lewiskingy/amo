(function initActuals(){
  ...
  function aggregateWorksheet(ws,{team=[],demand=[]}={}){
    ...
    for(let r=range.s.r+1;r<=range.e.r;r++){
      ...
      let person=null;if(rawStaffNumber||rawName){person=matchPerson(name=>get(r,name),scope).person;if(!person){stats.unmatchedStaffRows++;continue}}else if(!project){stats.outOfScopePersonlessRows++;continue}else stats.personlessProjectRows++;

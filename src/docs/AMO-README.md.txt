...
If configured, **AMO Assistant** appears at the top of navigation and launches the configured assistant URL in a new window. If the setting is blank, the navigation item is hidden.

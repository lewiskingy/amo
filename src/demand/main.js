...
actions.new.addEventListener('click',()=>page?.create());actions.editList.addEventListener('click',()=>page?.beginListEdit());actions.saveList.addEventListener('click',()=>page?.saveListEdit().catch(showError));actions.cancelList.addEventListener('click',()=>page?.cancelListEdit());actions.legacy.addEventListener('click',()=>{location.href='/'});actions.expand.addEventListener('click',()=>page?.expandAll());actions.collapse.addEventListener('click',()=>page?.collapseAll());actions.refresh.addEventListener('click',()=>refresh());

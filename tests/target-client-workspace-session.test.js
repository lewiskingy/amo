...
(async()=>{
  ...
  const source=fs.readFileSync('src/demand/main.js','utf8');assert.match(source,/new WorkspaceSession/);assert.match(source,/new WorkspaceSwitcher/);assert.doesNotMatch(source,/configuredLegacyRemoteGateway\(\)/);assert.match(fs.readFileSync('src/client/README.md','utf8'),/WorkspaceSession/);

...
const result=Actuals.aggregateWorksheet(ws,{team:[{id:'USR-1',name:'Person One',personNumber:'S1'},{id:'USR-2',name:'Person Two',personNumber:'S2'}],demand:[{id:'DEM-1',title:'Project A',projectNumber:'001'}]});
...
const august=result.periods.find(p=>p.month==='2026-08');assert.equal(august.facts.length,1);assert.equal(august.facts[0].personNumber,'S2');

...
assert.match(peopleGrid,/Staff Number and Name are required/);
assert.doesNotMatch(peopleGrid,/key:'personNumber'/);
assert.match(recordModal,/modalField\('Staff Number','staffNumber'/);
assert.match(recordModal,/next\.staffNumber/);
assert.match(userLink,/modalField\('Linked User','userId'/);
assert.match(userLink,/modalField\('Staff Number','staffNumber'/);
assert.match(userLink,/Staff Number is required/);
assert.match(actuals,/person\?\.staffNumber/);
assert.match(actuals,/staffNumber,personName/);

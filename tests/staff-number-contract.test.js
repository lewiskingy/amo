...
const resourcePlan=fs.readFileSync('src/app-resource-plan.js','utf8');
const periodPresentation=fs.readFileSync('src/app-reporting-period-presentation.js','utf8');
const resourceCompatibility=fs.readFileSync('src/app-4.js','utf8');
...
assert.match(resourcePlan,/basis=m=>reportingReady\?rm\?\.periodBasis\?\.\(m\)\|\|'forecast':'forecast'/,'Resource Plan must still derive period basis from ReportingModel');
...
require('./resource-plan-ownership.test.js');

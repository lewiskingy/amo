...
const report={
  ...
  entries:[{demandId:'DEM-1',title:'Demand One',owner:'Owner',services:['Design','Assurance'],health:'At Risk',statusUpdate:'Update',achievements:'Done',issues:'Issue',effortContext:{actualToDateFte:1.2,historicalForecastFte:1.6,varianceToDateFte:-.4,signal:'under-plan',message:'Actual effort is 25% below plan to date. 0.3 FTE-mo of planned shortfall coincides with those People recording effort on other Demand.'}}]
};
...
// Older immutable snapshots that stored singular service remain readable.

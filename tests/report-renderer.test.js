...
const report={
  ...
  entries:[{demandId:'DEM-1',title:'Demand One',owner:'Owner',services:['Design','Assurance'],workPackages:[{id:'WP-0001',title:'Integration Design',service:'Design',status:'In Progress',targetEnd:'2026-09-18'},{id:'WP-0002',title:'Data Migration',service:'Assurance',status:'Blocked',targetEnd:'2026-10-02'}],health:'At Risk',statusUpdate:'Update',achievements:'Done',issues:'Issue',effortContext:{actualToDateFte:1.2,historicalForecastFte:1.6,varianceToDateFte:-.4,signal:'under-plan',message:'Actual effort is 25% below plan to date.'}}]
};
...
assert.doesNotMatch(html,/Effort to date|Actual 1\.2 FTE-mo|under plan|Actual effort is 25% below plan/,'Status Report should not render per-Demand Actuals commentary');

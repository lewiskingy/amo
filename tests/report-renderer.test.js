...
const report={
  ...
  dashboardSnapshot:{actualsCoverage:'Actuals Jan 2026–Jul 2026',activeDemand:1,unallocated:0,inSocialisation:0,inGovernance:0,capacityConflicts:0,capacityOutlook:[{month:'2026-07-01',label:'Jul 2026',basis:'actual',capacityFte:2,reportedFte:1.5,allocatedFte:1.5,utilisationPct:75},{month:'2026-08-01',label:'Aug 2026',basis:'forecast',capacityFte:2,reportedFte:1.8,allocatedFte:1.8,utilisationPct:90}]},
